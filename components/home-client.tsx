...
import { Plus, MapPin, PawPrint, AlertTriangle, Search, HeartHandshake, Quote, Newspaper, Info } from "lucide-react"
      ...
      <main className="flex min-h-screen flex-col items-center justify-between">
        ...
        <section className="w-full bg-white py-16">
          <div className="container mx-auto px-4">
            <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-3xl md:text-4xl font-bold text-center text-amber-800 mb-10 flex items-center justify-center gap-2">
              <Quote className="h-7 w-7 text-amber-400" aria-hidden="true" />Success Stories
            </motion.h2>
        ...
        <section className="w-full bg-gradient-to-br from-amber-50 via-white to-amber-100 py-16">
          <div className="container mx-auto px-4">
            <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-3xl md:text-4xl font-bold text-center text-amber-800 mb-10 flex items-center justify-center gap-2">
              <Newspaper className="h-7 w-7 text-amber-400" aria-hidden="true" />From Our Blog
            </motion.h2>
        ...
        <section className="w-full py-20 bg-gradient-to-r from-amber-200 via-amber-100 to-white relative overflow-hidden">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7 }} className="container mx-auto px-4 flex flex-col items-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/emergency" className="bg-red-500 hover:bg-red-600 text-white font-bold px-6 py-3 rounded-lg shadow transition flex items-center gap-2">
                <AlertTriangle className="h-5 w-5 mr-1" aria-hidden="true" />Lost Pet Emergency
              </Link>
              <Link href="/lost" className="bg-amber-600 hover:bg-amber-700 text-white font-bold px-6 py-3 rounded-lg shadow transition flex items-center gap-2">
                <MapPin className="h-5 w-5 mr-1" aria-hidden="true" />Report Lost Pet
              </Link>
              <Link href="/found" className="bg-green-600 hover:bg-green-700 text-white font-bold px-6 py-3 rounded-lg shadow transition flex items-center gap-2">
                <Search className="h-5 w-5 mr-1" aria-hidden="true" />Report Found Pet
              </Link>
              <Link href="/volunteer" className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3 rounded-lg shadow transition flex items-center gap-2">
                <HeartHandshake className="h-5 w-5 mr-1" aria-hidden="true" />Volunteer
              </Link>
            </div>
          </motion.div>
        ...
        {!hasRequiredEnv && (
          <div className="w-full bg-amber-50 p-4 text-center flex items-center gap-2">
            <Info className="h-5 w-5 text-amber-700" aria-hidden="true" />Warning: Some environment variables are missing. The application may not function correctly.
          </div>
        )}
      </main>
