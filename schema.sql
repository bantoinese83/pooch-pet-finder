...
CREATE INDEX idx_pet_reports_report_type ON pet_reports(report_type);
CREATE INDEX idx_pet_reports_pet_type ON pet_reports(pet_type);
CREATE INDEX idx_pet_reports_status ON pet_reports(status);
CREATE INDEX idx_pet_reports_last_seen_date ON pet_reports(last_seen_date);
CREATE INDEX idx_pet_reports_day_found ON pet_reports(day_found);
CREATE INDEX idx_shelter_pets_pet_type ON shelter_pets(pet_type);
...
CREATE INDEX idx_pet_matches_lost_pet_id ON pet_matches(lost_pet_id);
CREATE INDEX idx_pet_matches_found_pet_id ON pet_matches(found_pet_id);
CREATE INDEX idx_pet_matches_status ON pet_matches(status);
